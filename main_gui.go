...
func (gui *SuperResolutionGUI) finishProcessing() {
...
func (gui *SuperResolutionGUI) onSaveResult() {
	...
	saveDialog := dialog.NewFileSave(func(writer fyne.URIWriteCloser) {
		if writer != nil {
			// Copy result file to chosen location
...
func (gui *SuperResolutionGUI) copyFile(src, dst string) error {
